def banner_text(text: str =" ", screen_width: int =80) -> None:
    ...
    :param text: The string to print.
        ...
        The default will print a blank line, with either a ** border at
        the left and right edges.
    :param screen_width: The overall width to print within
        (including the 4 spaces for the ** either side).

    :raises ValueError: If the supplied string is too to fit
    """
...
banner_text("Just pursue your lips and whistle - that's the thing!", 60)
