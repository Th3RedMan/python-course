...
def player_animation():
    ...
    #  play jumping animation if the player in not on the floor
...
# score_surface = test_font.render('My game', False, (64,64,64))  #  False is Anti-Aliasing
